...
export interface BusinessPlanResult {
  ...
  startup_items?: Array<{ item: string; price?: string; price_mln?: number | string; where_to_buy?: string }>;
  startup_costs?: Array<{ item: string; amount_mln?: number | string }>;
  total_startup_cost?: string;
  loan_needed?: string;
  monthly_plan?: { revenue?: string; expenses?: string; profit?: string; revenue_mln?: number | string; expenses_mln?: number | string; profit_mln?: number | string };
  ...
  recommended_loan?: { name: string; amount?: string; amount_mln?: number | string; rate: string; term?: string; why: string };
  first_steps?: string[];
