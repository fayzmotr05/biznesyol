...
export const questions: Question[] = [
  ...
  },
  {
    id: "repair_q7",
    type: "single_choice",
    text_uz: "Sertifikat yoki kurs tamomlaganmisiz?",
    text_ru: "Есть ли сертификат или курсы?",
    text_en: "Do you have any certificates?",
    options: [
      { value: "yes_cert", label_uz: "Ha, sertifikatim bor", label_ru: "Да, есть сертификат", label_en: "Yes, have a certificate" },
      { value: "course_only", label_uz: "Faqat kurs tamomlaganman", label_ru: "Только курсы", label_en: "Completed a course only" },
      { value: "self_taught", label_uz: "O'zim o'rganganman", label_ru: "Самоучка", label_en: "Self-taught" },
      { value: "none", label_uz: "Yo'q", label_ru: "Нет", label_en: "None" },
    ],
    required: true,
    next: () => "exact_capital",
  },
  ...
  },
  {
    id: "transport_q5",
    type: "single_choice",
    text_uz: "Mashina sug'urtangiz bormi?",
    text_ru: "Есть ли страховка на автомобиль?",
    text_en: "Do you have car insurance?",
    options: [
      { value: "osago", label_uz: "OSAGO bor", label_ru: "Есть ОСАГО", label_en: "Have OSAGO" },
      { value: "full", label_uz: "To'liq sug'urta", label_ru: "Полная страховка", label_en: "Full insurance" },
      { value: "none", label_uz: "Yo'q", label_ru: "Нет", label_en: "None" },
    ],
    required: true,
    next: () => "transport_q6",
  ...
  },
  {
    id: "education_q6",
    type: "single_choice",
    text_uz: "Qanday sertifikat yoki diplomingiz bor?",
    text_ru: "Какой сертификат или диплом у вас есть?",
    text_en: "What certificates or diplomas do you have?",
    options: [
      { value: "diploma", label_uz: "Oliy ta'lim diplomi", label_ru: "Диплом высшего образования", label_en: "University diploma" },
      { value: "certificate", label_uz: "Sertifikat", label_ru: "Сертификат", label_en: "Certificate" },
      { value: "no_cert", label_uz: "Yo'q", label_ru: "Нет", label_en: "None" },
    ],
    required: true,
    next: () => "exact_capital",
  },
  ...
  },
  {
    id: "digital_q5",
    type: "single_choice",
    text_uz: "Portfoliongiz bormi?",
    text_ru: "Есть ли у вас портфолио?",
    text_en: "Do you have a portfolio?",
    options: [
      { value: "yes_portfolio", label_uz: "Ha, ishlarim bor", label_ru: "Да, есть мои работы", label_en: "Yes, I have works" },
      { value: "some_work", label_uz: "Bir nechta ish", label_ru: "Несколько работ", label_en: "A few works" },
      { value: "nothing", label_uz: "Yo'q", label_ru: "Нет", label_en: "Nothing" },
    ],
    required: true,
    next: () => "digital_q6",
  },
